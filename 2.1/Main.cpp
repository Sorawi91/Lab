...
void reverse (char str1[], char str2[]){
    ...
    while (str1[len] != '\0') { 
        ...
        len++;                        
        //ทำการ loop ไปเรื่อยๆจนกว่าจะเจอ \0 เพราะเป็นตัวสุดท้ายที่ใช้ปิดท้ายใน array
    } 
    ...
    for (int i = len -1; i >= 0 ; i--) { 
        ...
        str2[j] = str1[i]; 
        //ให้ str1[i] คือค่าตั้งเเต่ str[9] ลงมานำค่าไปใส่ใน str2[j] ที่เริ่มต้นตั้งเเต่ 0  
        j++; 
